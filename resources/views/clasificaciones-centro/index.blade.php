                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($clasificacionesCentros as $clasificacionesCentro)
										...
										<td >{{ $clasificacionesCentro->id_areas }}</td>

                                            <td>
                                                <form action="{{ route('clasificaciones-centros.destroy', $clasificacionesCentro->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('clasificaciones-centros.show', $clasificacionesCentro->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('clasificaciones-centros.edit', $clasificacionesCentro->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
