                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <form action="{{ route('import-referencia') }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                @csrf
                    ...
                    <div class="card-body bg-white">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="referencia">
                                <thead class="thead">
                                    <tr>
                                        <th>No</th>
										...
										<td >{{ $referenciaGasto->nombre }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('referencia-gastos.destroy', $referenciaGasto->codigo) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('referencia-gastos.show', $referenciaGasto->codigo) }}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('referencia-gastos.edit', $referenciaGasto->codigo) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
