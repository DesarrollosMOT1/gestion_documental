										...
										<td >{{ $nivelesDo->id_niveles_uno }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('niveles-dos.destroy', $nivelesDo->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('niveles-dos.show', $nivelesDo->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('niveles-dos.edit', $nivelesDo->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
