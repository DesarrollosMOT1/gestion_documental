...
<div class="tab-content" id="formTabsContent">
    ...
    <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="fecha_inicio_vigencia" class="form-control @error('fecha_inicio_vigencia') is-invalid @enderror" value="{{ old('fecha_inicio_vigencia', $cotizacione?->fecha_inicio_vigencia) }}" id="fecha_inicio_vigencia" placeholder="Fecha Inicio Vigencia">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="fecha_fin_vigencia" class="form-control @error('fecha_fin_vigencia') is-invalid @enderror" value="{{ old('fecha_fin_vigencia', $cotizacione?->fecha_fin_vigencia) }}" id="fecha_fin_vigencia" placeholder="Fecha Fin Vigencia">
