...
<ul class="nav nav-tabs" id="formTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link" id="tab2-tab" data-bs-toggle="tab" href="#tab2" role="tab" aria-controls="tab2"
            aria-selected="false">Solicitudes Seleccionadas</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link" id="tab3-tab" data-bs-toggle="tab" href="#tab3" role="tab" aria-controls="tab3"
            aria-selected="false">Elementos de las Solicitudes</a>
    </li>
</ul>
    ...
    <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
        <div class="form-group mb-2">
            ...
            <input type="date" name="fecha_cotizacion"
                ...
                value="{{ old('fecha_cotizacion', $fechaActual) }}" id="fecha_cotizacion"
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                value="{{ old('nombre', $cotizacione?->nombre) }}" id="nombre" placeholder="Nombre">
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" name="valor" class="form-control @error('valor') is-invalid @enderror"
                value="{{ old('valor', $cotizacione?->valor) }}" id="valor" placeholder="Valor" readonly>
        ...
        <div class="form-group mb-2">
            ...
            <select name="condiciones_pago" class="form-control @error('condiciones_pago') is-invalid @enderror"
                id="condiciones_pago">
                <option value="">{{ __('Seleccione una opción') }}</option>
                <option value="30 días"
                    {{ old('condiciones_pago', $cotizacione?->condiciones_pago) == '30 días' ? 'selected' : '' }}>30
                    días</option>
                <option value="contado"
                    {{ old('condiciones_pago', $cotizacione?->condiciones_pago) == 'contado' ? 'selected' : '' }}>
                    Contado</option>
                <option value="crédito"
                    {{ old('condiciones_pago', $cotizacione?->condiciones_pago) == 'crédito' ? 'selected' : '' }}>
                    Crédito</option>
            </select>
            {!! $errors->first(
                'condiciones_pago',
        ...
        <div class="form-group mb-2">
            ...
            <input type="number" name="descuento" class="form-control @error('descuento') is-invalid @enderror"
                value="{{ old('descuento', $cotizacione?->descuento) }}" id="descuento" placeholder="Descuento">
        ...
        <div class="form-group mb-2">
            ...
            <select name="id_terceros" class="form-control @error('id_terceros') is-invalid @enderror" id="id_terceros">
                ...
                @foreach ($terceros as $tercero)
                    <option value="{{ $tercero->nit }}"
                        {{ old('id_terceros', $cotizacione?->id_terceros) == $tercero->nit ? 'selected' : '' }}>
                        {{ $tercero->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="fecha_inicio_vigencia"
                ...
                value="{{ old('fecha_inicio_vigencia', $cotizacione?->fecha_inicio_vigencia) }}"
                id="fecha_inicio_vigencia" placeholder="Fecha Inicio Vigencia">
            {!! $errors->first(
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="fecha_fin_vigencia"
                ...
                value="{{ old('fecha_fin_vigencia', $cotizacione?->fecha_fin_vigencia) }}" id="fecha_fin_vigencia"
...
<div class="col-md-12 mt20 mt-2">
    <button id="btnEnviar" type="submit" class="btn btn-primary">{{ __('Crear') }}</button>
</div>
