                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <form action="{{ route('import-linea') }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                @csrf
                             ...
                             <div class="float-right">
                                <a href="{{ route('lineas-gastos.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Crear Nuevo') }}
                                </a>
                              </div>
                        </div>
                    ...
                    <div class="card-body bg-white">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="lineas">
                                ...
                                <tbody>
                                    @foreach ($lineasGastos as $lineasGasto)
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            
										<td >{{ $lineasGasto->codigo }}</td>
										<td >{{ $lineasGasto->nombre }}</td>

                                            <td>
                                                <form action="{{ route('lineas-gastos.destroy', $lineasGasto->codigo) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('lineas-gastos.show', $lineasGasto->codigo) }}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('lineas-gastos.edit', $lineasGasto->codigo) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
