										...
										<td >{{ $nivelesTre->id_referencias_gastos }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('niveles-tres.destroy', $nivelesTre->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('niveles-tres.show', $nivelesTre->id) }}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('niveles-tres.edit', $nivelesTre->id) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
