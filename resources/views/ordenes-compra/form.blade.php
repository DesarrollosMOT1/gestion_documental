    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="date" name="fecha_emision" class="form-control @error('fecha_emision') is-invalid @enderror"
                value="{{ old('fecha_emision', $ordenesCompra?->fecha_emision) }}" id="fecha_emision"
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="subtotal" class="form-control @error('subtotal') is-invalid @enderror"
                value="{{ old('subtotal', $ordenesCompra?->subtotal) }}" id="subtotal" placeholder="Subtotal">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="total" class="form-control @error('total') is-invalid @enderror"
                value="{{ old('total', $ordenesCompra?->total) }}" id="total" placeholder="Total">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="text" name="cantidad_total"
                ...
                value="{{ old('cantidad_total', $ordenesCompra?->cantidad_total) }}" id="cantidad_total"
        ...
        <div class="form-group mb-3">
            ...
            <textarea name="nota" class="form-control @error('nota') is-invalid @enderror" id="nota" rows="4"
                placeholder="Nota">{{ old('nota', $ordenesCompra?->nota) }}</textarea>
