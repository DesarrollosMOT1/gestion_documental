    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @foreach($ordenesCompra->ordenesCompraCotizaciones as $ordenCompraCotizacion)
                    @if($ordenCompraCotizacion->consolidacione && $ordenCompraCotizacion->consolidacione->elementosConsolidados->isNotEmpty())
                        <x-elementos-consolidados-modal 
                            :consolidacion="$ordenCompraCotizacion->consolidacione" 
                            :modal-id="'modalElementosConsolidados' . $ordenCompraCotizacion->consolidacione->id" 
                        />
                    @endif
                @endforeach
