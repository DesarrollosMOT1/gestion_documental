<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_clasificaciones_centros" class="form-control @error('id_clasificaciones_centros') is-invalid @enderror" value="{{ old('id_clasificaciones_centros', $nivelesUno?->id_clasificaciones_centros) }}" id="id_clasificaciones_centros" placeholder="Id Clasificaciones Centros">
