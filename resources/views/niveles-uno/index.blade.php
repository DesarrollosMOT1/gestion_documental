										...
										<td >{{ $nivelesUno->id_clasificaciones_centros }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('niveles-unos.destroy', $nivelesUno->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('niveles-unos.show', $nivelesUno->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('niveles-unos.edit', $nivelesUno->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
